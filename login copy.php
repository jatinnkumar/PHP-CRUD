...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    echo"Wrong Email or Password , Please Register First...";
}
    ...
    <div class="row">
        ...
        <div class="col2">
            ...
            <form id="login" method="post" action="">
                ...
                <input type="checkbox" id="rememberMe" name="rememberMe"  <?php if(isset($_COOKIE["email"])) { ?> checked <?php } ?> />
                <label for="rememberMe">Remember Me</label><br>
            </form>
        </div>
        <div class="col3">
            <a href="register.php" id="register" name="register">Register</a>
        </div>
    </div>
</body>
</html>
